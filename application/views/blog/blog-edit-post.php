...
<div class="row" style="margin-left:30px; margin-right:30px;">
  <div class="col-sm-12">
            <section class="panel">
              <header class="panel-heading font-bold"><h3><?php echo('Edit blog post') ?></h3></header>
                          ...
                          <div class="panel-body"> 
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                 ...
                                 <img class="img-responsive" src="<?php echo base_url("img/uploads/$row->picture"); ?>" alt="image" style="max-width:100px;"/>
                            ...
                            <div class="form-group"> 
                              ...
                              <div class="col-sm-10"> <div class="btn-toolbar m-b-sm btn-editor" data-role="editor-toolbar" data-target="#editor">  
                                  ...
                                  <div id="editor" class="form-control" style="overflow:scroll;height:250px;max-height:250px" contenteditable="true"> <?php echo $row->content; ?> </div>
                                </div>
                              </div> 
